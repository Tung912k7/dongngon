  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      if (result.success) {
        ...
        logger.error("Lỗi xóa từ Database:", result.error);
          ...
          <AnimatePresence>
            {isOpen && (
              <div className="fixed inset-0 z-[110] flex items-center justify-center p-4">
                ...
                >
                  <h2 className="text-2xl font-black mb-4 text-center uppercase tracking-tight text-black">
                    Xác nhận xóa
                  </h2>
                  <p className="text-center text-gray-500 mb-8">
                    Bạn có chắc chắn muốn xóa tác phẩm{" "}
                    <span className="font-bold text-black">&quot;{workTitle}&quot;</span>? Hành động
