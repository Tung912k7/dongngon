      ...
      >
        ...
        <div className="flex-grow min-w-0 pr-8">
          <div className="flex flex-col sm:flex-row sm:items-baseline gap-1 sm:gap-3 mb-1">
            <h3 className="text-xl font-ganh font-bold text-black truncate tracking-tight">
              {work.title}
            </h3>
        ...
        {showPrivateNotice && (
          ...
          >
            <div className="bg-black/95 backdrop-blur-md text-white px-6 py-4 rounded-2xl border border-white/20 shadow-2xl flex items-center gap-4">
              ...
              <div>
                <p className="font-black uppercase tracking-[0.2em] text-[8px] opacity-60">
                  Thông báo
                </p>
