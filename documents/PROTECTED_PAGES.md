...
| `/admin/quotes` | Quản lý trích dẫn hiển thị ở footer và import dữ liệu từ Excel. |

## 4. Cơ Chế Thực Thi (Implementation)
- **Proxy**: Sử dụng Next.js Proxy (`proxy.ts`) để kiểm tra session và vai trò người dùng trước khi render trang.
