...
export default async function DongNgonPage({
  ...
  if (q && contentMatchesResponse.data) {
    contentMatchedWorkIds = [...new Set(contentMatchesResponse.data.map((c) => c.work_id))];
  }
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Mỗi một tác phẩm là một hạt giống đang chờ bạn vun trồng. Triệu hạt giống tạo nên cánh đồng văn học bạt ngàn và vô tận.",
            url: "https://dongngon.vercel.app/kho-tang",
            isPartOf: {
              "@type": "WebSite",
