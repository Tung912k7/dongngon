  ...
  useEffect(() => {
    ...
    const {
      ...
      if (event === "SIGNED_OUT") {
        ...
        const isPublicPage =
          pathname === "/" || pathname === "/dong-ngon" || pathname.startsWith("/work/");
        if (
          !isPublicPage &&
          (wasLoggedIn || pathname.startsWith("/profile") || pathname.startsWith("/settings"))
        ) {
        ...
        <div className="flex items-center justify-center min-h-[200px] p-4 text-center">
          <div>
            ...
            <p className="text-gray-600 mb-4">
              Chúng mình đã ghi nhận lỗi này và sẽ sớm khắc phục.
            </p>
            <button
