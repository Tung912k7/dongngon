...
const CONTACT_CARDS: ContactCard[] = [
  {
    ...
    ctaLabel: "Gửi góp ý",
    ctaHref:
      "https://docs.google.com/forms/d/e/1FAIpQLSfRTalgsKarNe4OgmxFg1XRkoZnmu_nmofaZZ8s3BOHbN5xYw/viewform",
  },
  {
    icon: (
      <svg
...
const FAQ_ITEMS: FAQItem[] = [
  {
    ...
    answer:
      "Khi nền tảng đủ lớn, chúng mình sẽ thêm các lựa chọn ngôn ngữ cho các tác phẩm để làm đa dạng hơn không chỉ về thể loại mà còn ngôn ngữ của các tác phẩm.",
  },
  {
    question: "Đồng ngôn do mấy người làm?",
    answer:
      "Đồng ngôn hiện tại có 1 người phát triển và vận hành, còn bạn kia thì sẽ hỗ trợ tuỳ tình hình.",
  },
  {
    question: "Tôi có thể tạo những loại tác phẩm nào?",
    answer:
      "Đồng Ngôn hỗ trợ nhiều thể loại sáng tác bao gồm: Thơ tự do, Thơ tứ ngôn, Văn xuôi (truyện ngắn, tản văn), Nhật ký, và Tùy bút. Bạn có thể chọn thể loại khi tạo tác phẩm mới.",
  },
  {
    question: "Làm cách nào để đóng góp vào tác phẩm chung?",
    answer:
      'Truy cập trang Kho tàng, Chọn 1 tác phẩm mà bạn muốn và bấm vào nút "Đến tác phẩm" để đọc và đóng góp cho tác phẩm.',
  },
  {
    question: "Tại sao tác phẩm của tôi bị đánh dấu hoặc hạn chế?",
    answer:
      "Tác phẩm có thể bị đánh dấu nếu vi phạm quy định cộng đồng về nội dung. Bạn có thể xem chi tiết lý do trong mục Thông báo và gửi phản hồi nếu cho rằng đây là nhầm lẫn.",
  },
  {
